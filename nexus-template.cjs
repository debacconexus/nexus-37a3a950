...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Kim DeBacco Consulting Practice Management";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Client Engagement";
process.env.TABLE_NAME = process.env.TABLE_NAME || "client_engagement_records";
'use strict';
